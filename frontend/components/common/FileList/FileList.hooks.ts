...
/**
 * Custom hook to manage file list and handle drag-and-drop reordering.
 * @param {number | undefined} groupId - The ID of the group to which the files belong.
 * @param {ResponseFile[]} items - The initial list of files.
 * @returns {[ResponseFile[] | undefined, (event: DragEndEvent) => void]} - The current file list and a function to handle drag end events.
 */
export const useFileList = (groupId: number | undefined, items: ResponseFile[]) => {
